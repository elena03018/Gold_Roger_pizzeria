        ...
        $builder
            ...
            ->add('plainPassword', RepeatedType::class, [
                ...
                'first_options' => [
                    'constraints' => [
                        new NotBlank([
                            'message' => 'Le nouveau mot de pass est obligatoire',
                        ]),
                        new Length([
                            'min' => 12,
                            'max' => 255,
                            'minMessage' => 'Le nouveau mot de pass doit contenir au minimum{{ limit }} caractères',
                            'maxMessage' => 'Le nouveau mot de pass doit contenir au maximum{{ limit }} caractères',
                        ]),
                        new Regex([
                        ...
                        new NotCompromisedPassword([
                            'message' => "Votre mot de pass est facilment piratable! Veuillez en choisir un autre."
                        ])
                    ],
